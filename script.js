...
const KIDS_FUTURE_PATHS = {
  ...
  zh: [
    ...
    { text: '也许会是家里负责让大家和好的人。', tag: 'A' },
    { text: '也许会说出比年龄成熟得多的建议。', tag: 'A' },
  ...
  ja: [
    ...
    { text: '家族のなかの「仲なおりがかり」になるかも。', tag: 'A' },
    { text: '年齢のわりに、はっとさせられる助言をくれるかも。', tag: 'A' },
  ...
  ko: [
    ...
    { text: '가족 안에서 화해를 도맡는 아이가 될 수 있어요.', tag: 'A' },
    { text: '나이에 비해 놀랍도록 지혜로운 조언을 줄지도 몰라요.', tag: 'A' },
    ...
    { text: '언젠가 멋진 선생님이 될 수 있어요.', tag: 'A' },
  ...
  tr: [
    ...
    { text: 'Hikaye anlatmakta çok yetenekli olabilir.', tag: 'O' },
    { text: 'Başkalarına yardım etmekten hoşlanabilir.', tag: 'A' },
    { text: 'Muhtemelen pek çok soru soracak.', tag: 'O' },
    { text: 'İlgisi defalarca değişebilir — bunda bir sorun yok.', tag: 'O' },
    ...
    { text: 'Küçük maceralar için ince ince plan yapmaya bayılabilir.', tag: 'C' },
    ...
    { text: 'Ailede barışı sağlayan kişi olabilir.', tag: 'A' },
    { text: 'Yaşına göre şaşırtıcı derecede akıllı tavsiyeler verebilir.', tag: 'A' },
    ...
    { text: 'Bir gün harika bir öğretmen olabilir.', tag: 'A' },
