...
const STRINGS = {
  ...
  zh: {
    ...
    'section.env.hint.adult': '可选 · 微调以细化预测',
    'about.title': '关于 — BabyBlend Lab',
    'about.back': '← 返回实验室',
    'about.h1': '关于 BabyBlend Lab',
    'about.sub': '关于人类增强伦理的思辨性模拟。',
    'about.what.h': '这是什么',
    'about.what.p1': 'BabyBlend Lab 是一个虚构的单页交互作品,探讨近未来消费级生物科技产品可能如何呈现自身：制度化的语言、置信区间、监管免责声明,以及特征配置界面。您输入两位家长,可选择在九个类别中分配<em>增强额度</em>,系统将投射一个可能的孩子,以及这些选择带来的社会、监管和身份后果。',
    'about.what.p2': '这里没有任何东西可以预测真实的孩子。机制是刻意的夸张漫画。但界面提出的伦理问题,不是。',
    'about.modes.h': '三种模式,三种论点',
    'about.modes.intro': '同一个虚构的孩子可以以三种语域呈现。每种模式所论证的事情不同。',
    'about.modes.adult.name': '成人',
    'about.modes.adult.body': '临床式的生物科技产品语域。将模拟视为一个真实的消费功能：Beta 标签、成本层级、监管通知、预测置信度小标签。它所论证的是<em>哪些不该被优化。</em>《社会结果简报》《成本／准入层级条》《同胞队列方差行》《分歧事件》以及《历史漂移》时间轴,共同显示出：即便最具权威外观的预测,也是脆弱、不平等、文化上局部的。',
    'about.modes.reflection.name': '沉思',
    'about.modes.reflection.body': '沉思式的语域。将同一个孩子视为一个人——其人生无法被滑动条所捕捉。它所论证的是<em>这些预测看不见什么。</em>《特征星座》《记忆卡》《内在群像》《一生漂移》《暂停面板》各自呈现模型遗漏的某一维度——感官的质地、私密的房间、几十年的自我修订,以及那些滑动条无法询问的事物。',
    'about.modes.kids.name': '儿童',
    'about.modes.kids.body': '惊奇／好奇的语域。将模拟视为一件友好的教室器物——更柔和的色彩、更简单的标签、更温和的问题。是三种语域中最轻的一种,且是有意为之。',
    'about.real.h': '什么是真实的,什么不是',
    'about.real.title': '真实',
    'about.real.li1': '简介时间轴中的每一项事件与引用 (1978 年体外受精、1990 年植入前基因诊断、2012 年 CRISPR-Cas9、2018 年贺建奎双胞胎、2019 年判决、2020 年诺贝尔奖、2023 年英国 Casgevy 批准)。',
    'about.real.li2': '大五人格 (OCEAN) 模型,以及其约 40–60% 的双胞胎研究遗传率范围。',
    'about.real.li3': 'OCEAN 滑动条所用的多基因+高斯噪声继承形状。',
    'about.real.li4': '美容手术数据 (ISAPS)、"Snapchat 畸形恐惧症" (JAMA Facial Plastic Surgery)、身体畸形障碍发病率 (Veale 等)、以及 75 个以上限制可遗传基因编辑的国家 (Baylis 等)。',
    'about.fic.title': '虚构',
    'about.fic.li1': '《增强配额》预算、单点成本、《准入层级》阈值、地区准入条目、以及《队列定位》百分位。这些建模的是,一个真实的生物科技产品可能如何为这些事物定价与排序——而非当前技术真正能做到什么。',
    'about.fic.li2': '《社会结果简报》中的条目。基于社会科学关于期望效应与准入错配的直觉的启发式,但不具有预测性。',
    'about.fic.li3': '《分歧事件》。虚构的人生片段；真正成立的是其<em>原则</em>(普通生活事件的影响大于特征预测)。',
    'about.fic.li4': 'DiceBear 头像。插画化的替身,而非照片。',
    'about.process.h': '制作笔记',
    'about.process.p1': '使用原生 HTML / CSS / JavaScript 构建——无框架、无构建步骤。任何人都可以阅读源代码。头像样式来自 <a href="https://www.dicebear.com" style="color: var(--accent); text-decoration: none;">DiceBear</a>,通过 CDN 加载。',
    'about.process.p2': '在迭代中设计。最初的版本是一个"做一个可爱宝宝"的小玩具。经过许多次迭代,它逐渐成长为一个三模式的伦理界面。用户所经历的弧线——从俏皮的好奇,穿过制度化的优化,到安静的反思——也映照了项目本身在构建过程中所走过的弧线。',
    'about.process.p3': '托管于 GitHub Pages。模拟器位于 <a href="./" style="color: var(--accent); text-decoration: none;">acceleration1st.com</a>。',
    'about.cites.h': '参考文献',
    'about.cite.1': 'Steptoe PC, Edwards RG. Birth after the reimplantation of a human embryo. <em>The Lancet</em>, 312(8085):366, 1978.',
    'about.cite.2': 'Handyside AH, Kontogianni EH, Hardy K, Winston RM. Pregnancies from biopsied human preimplantation embryos sexed by Y-specific DNA amplification. <em>Nature</em>, 344:768–770, 1990.',
    'about.cite.3': 'Jinek M, Chylinski K, Fonfara I, Hauer M, Doudna JA, Charpentier E. A programmable dual-RNA–guided DNA endonuclease in adaptive bacterial immunity. <em>Science</em>, 337(6096):816–821, 2012.',
    ...
    'about.cite.11': 'Bouchard TJ Jr. Genes, environment, and personality. <em>Science</em>, 264(5166):1700–1701, 1994.',
    'about.cite.12': 'Plomin R, DeFries JC, Knopik VS, Neiderhiser JM. <em>Behavioral Genetics</em>, 6th ed. Worth Publishers, 2013.',
    'about.meta': '虚构模拟。非医学或基因建议。当前的伦理监管因地区而异。',
    'language.label': '语言'
  },
  ...
  ja: {
    ...
    'section.env.hint.adult': '任意 · 微調整して予測を精緻化',
    'about.title': '概要 — BabyBlend Lab',
    'about.back': '← ラボに戻る',
    'about.h1': 'BabyBlend Lab について',
    'about.sub': '人間強化の倫理に関する思索的シミュレーション。',
    'about.what.h': 'これは何か',
    'about.what.p1': 'BabyBlend Lab は、近未来の消費者向けバイオテクノロジー製品がどのように自身を提示しうるかを描いた、架空のシングルページのインタラクティブ作品です。制度的な言葉遣い、信頼区間、規制上の免責事項、形質の設定インターフェース——あなたは両親二人を入力し、任意で九つのカテゴリーに<em>強化クレジット</em>を割り当て、システムはありうる子どもと、その選択がもたらす社会的・規制的・アイデンティティ上の帰結を投影します。',
    'about.what.p2': 'ここにあるどれも、実在する子どもを予測するものではありません。仕組みは意図的なカリカチュアです。インターフェースが投げかける倫理的問いは、そうではありません。',
    'about.modes.h': '三つのモード、三つの主張',
    'about.modes.intro': '同じ架空の子どもを三つのレジスターで見ることができます。各モードは異なる主張をしています。',
    'about.modes.adult.name': 'アダルト',
    'about.modes.adult.body': '臨床的なバイオテック製品のレジスター。シミュレーションを実在する消費者向け機能のように扱います——Beta タグ、コスト階層、規制上の通知、予測信頼度のピル。その主張は<em>「何を最適化すべきでないか」</em>。《社会的帰結ブリーフ》《コスト／アクセス階層》《同胞コホート分散行》《分岐イベント》《歴史的ドリフト》のタイムラインが、もっとも権威的に見える瞬間にも、その投影が脆く、不平等で、文化的に局所的であることを示します。',
    'about.modes.reflection.name': '内省',
    'about.modes.reflection.body': '内省的なレジスター。同じ子どもを、その人生をスライダーには還元できない一人の人間として扱います。その主張は<em>「これらの投影には何が見えていないか」</em>。《形質の星座》《メモリーカード》《内なるコホート》《生涯ドリフト》《一時停止パネル》が、モデルが省略している人格の次元——感覚的なきめ、私的な部屋、何十年もの自己改訂、スライダーが訊けないもの——を浮かび上がらせます。',
    'about.modes.kids.name': 'キッズ',
    'about.modes.kids.body': '驚き／好奇のレジスター。シミュレーションを親しみやすい教室の道具として扱います——柔らかいパレット、より単純なラベル、よりやさしい問い。三つの中でいちばん軽く、それは意図したものです。',
    'about.real.h': '何が現実で、何がそうでないか',
    'about.real.title': '現実',
    'about.real.li1': 'イントロのタイムラインに含まれるすべての出来事と引用 (1978 年体外受精、1990 年着床前遺伝子診断、2012 年 CRISPR-Cas9、2018 年の賀建奎双子、2019 年の判決、2020 年のノーベル賞、2023 年英国 Casgevy 承認)。',
    'about.real.li2': 'ビッグファイブ (OCEAN) 人格モデル、および双子研究で示される約 40–60% の遺伝率の範囲。',
    'about.real.li3': 'OCEAN スライダーが用いる、多遺伝子＋ガウスノイズによる継承の形。',
    'about.real.li4': '美容処置の統計 (ISAPS)、「Snapchat 醜形恐怖症」(JAMA Facial Plastic Surgery)、身体醜形障害の有病率 (Veale ら)、可遺伝性編集を制限する 75 か国以上 (Baylis ら)。',
    'about.fic.title': '架空',
    'about.fic.li1': '《強化アロケーション》の予算、クレジット単価、《アクセス階層》の閾値、地域アクセス行、《コホート位置》のパーセンタイル。これらは、現在の技術が実際にできることではなく、実在の生物科技製品がそうしたものをどのように値付けし序列化しうるかをモデル化したものです。',
    'about.fic.li2': '《社会的帰結ブリーフ》の行。社会科学的な直感(期待効果、アクセスのミスマッチ)に基づくヒューリスティックであり、予測ではありません。',
    'about.fic.li3': '《分岐イベント》。架空の伝記です。現実なのはその<em>原理</em>(日常の出来事は形質予測を上回る、ということ)です。',
    'about.fic.li4': 'DiceBear のアバター。イラスト化された代役であり、写真ではありません。',
    'about.process.h': '制作ノート',
    'about.process.p1': '素のままの HTML / CSS / JavaScript で構築——フレームワークなし、ビルド工程なし。誰でもソースを読めます。アバターは <a href="https://www.dicebear.com" style="color: var(--accent); text-decoration: none;">DiceBear</a> を CDN から読み込んでいます。',
    'about.process.p2': '反復のなかで設計しました。最初のバージョンは「かわいい赤ちゃんを作る」おもちゃでした。多くのセッションを経て、三モードの倫理インターフェースへと育ちました。ユーザーがたどる弧——遊び心ある好奇から、制度的な最適化を経て、静かな内省へ——は、構築過程でプロジェクト自体がたどった弧でもあります。',
    'about.process.p3': 'GitHub Pages にホストされています。シミュレーターは <a href="./" style="color: var(--accent); text-decoration: none;">acceleration1st.com</a> にあります。',
    'about.cites.h': '参考文献',
    'about.cite.1': 'Steptoe PC, Edwards RG. Birth after the reimplantation of a human embryo. <em>The Lancet</em>, 312(8085):366, 1978.',
    'about.cite.2': 'Handyside AH, Kontogianni EH, Hardy K, Winston RM. Pregnancies from biopsied human preimplantation embryos sexed by Y-specific DNA amplification. <em>Nature</em>, 344:768–770, 1990.',
    'about.cite.3': 'Jinek M, Chylinski K, Fonfara I, Hauer M, Doudna JA, Charpentier E. A programmable dual-RNA–guided DNA endonuclease in adaptive bacterial immunity. <em>Science</em>, 337(6096):816–821, 2012.',
    ...
    'about.cite.11': 'Bouchard TJ Jr. Genes, environment, and personality. <em>Science</em>, 264(5166):1700–1701, 1994.',
    'about.cite.12': 'Plomin R, DeFries JC, Knopik VS, Neiderhiser JM. <em>Behavioral Genetics</em>, 6th ed. Worth Publishers, 2013.',
    'about.meta': '架空のシミュレーションです。医療的・遺伝的助言ではありません。現行の倫理規制は地域によって異なります。',
    'language.label': '言語'
  },
  ...
  ko: {
    ...
    'section.env.hint.adult': '선택 · 조정해서 예측을 정교화',
    'about.title': '소개 — BabyBlend Lab',
    'about.back': '← 랩으로 돌아가기',
    'about.h1': 'BabyBlend Lab 소개',
    'about.sub': '인간 강화의 윤리에 관한 사변적 시뮬레이션.',
    'about.what.h': '이것은 무엇인가',
    'about.what.p1': 'BabyBlend Lab은 가까운 미래의 소비자용 생명공학 제품이 어떤 모습으로 자신을 드러낼 수 있는지에 관한 가상의 단일 페이지 인터랙티브 작품입니다. 제도적 언어, 신뢰 구간, 규제 면책 조항, 그리고 특성을 설정하는 인터페이스. 두 부모를 입력하고, 선택적으로 아홉 개 범주에 <em>강화 크레딧</em>을 배분하면, 시스템은 가능한 자녀와 그 선택이 가져올 사회적·규제적·정체성적 결과를 투사합니다.',
    'about.what.p2': '여기 그 어떤 것도 실제 아이를 예측하지 않습니다. 메커니즘은 의도된 풍자입니다. 인터페이스가 제기하는 윤리적 질문들은 그렇지 않습니다.',
    'about.modes.h': '세 가지 모드, 세 가지 주장',
    'about.modes.intro': '같은 가상의 아이를 세 가지 어조로 볼 수 있습니다. 각 모드는 서로 다른 것을 주장합니다.',
    'about.modes.adult.name': '어덜트',
    'about.modes.adult.body': '임상적인 생명공학 제품 어조. 시뮬레이션을 실제 소비자용 기능처럼 다룹니다 — Beta 태그, 비용 등급, 규제 알림, 예측 신뢰도 라벨. 이 모드의 주장은 <em>"무엇을 최적화해서는 안 되는가"</em>. 《사회적 결과 브리프》, 《비용/접근 등급 스트립》, 《형제 코호트 분산 행》, 《분기 사건》, 《역사적 드리프트》 타임라인이 함께, 가장 권위적으로 보이는 순간조차 그 투영이 취약하고 불평등하며 문화적으로 국지적임을 드러냅니다.',
    'about.modes.reflection.name': '성찰',
    'about.modes.reflection.body': '성찰적 어조. 같은 아이를, 그 인생이 슬라이더로 환원될 수 없는 한 사람으로 다룹니다. 이 모드의 주장은 <em>"이 투영들이 무엇을 볼 수 없는가"</em>. 《특성 별자리》, 《메모리 카드》, 《내적 코호트》, 《생애 드리프트》, 《잠시 멈춤 패널》이 각자, 모델이 빠뜨린 인격의 한 차원 — 감각적 결, 사적인 방, 수십 년에 걸친 자기 수정, 슬라이더가 물어볼 수 없는 것들 — 을 드러냅니다.',
    'about.modes.kids.name': '키즈',
    'about.modes.kids.body': '경이/호기심의 어조. 시뮬레이션을 친근한 교실 도구처럼 다룹니다 — 더 부드러운 팔레트, 더 단순한 라벨, 더 부드러운 질문. 세 어조 가운데 가장 가벼우며, 의도된 결과입니다.',
    'about.real.h': '무엇이 실재이고, 무엇이 아닌가',
    'about.real.title': '실재',
    'about.real.li1': '인트로 타임라인의 모든 사건과 인용 (1978년 시험관 수정, 1990년 착상 전 유전자 진단, 2012년 CRISPR-Cas9, 2018년 허젠쿠이 쌍둥이, 2019년 선고, 2020년 노벨상, 2023년 영국 Casgevy 승인).',
    'about.real.li2': 'Big Five (OCEAN) 성격 모델과 쌍둥이 연구에서 추정된 약 40–60%의 유전율 범위.',
    'about.real.li3': 'OCEAN 슬라이더에 사용된 다유전자+가우시안 잡음 유전 모델 형태.',
    'about.real.li4': '미용 시술 통계 (ISAPS), "Snapchat 신체이형" (JAMA Facial Plastic Surgery), 신체이형장애 유병률 (Veale 등), 그리고 유전 가능 편집을 제한하는 75개국 이상 (Baylis 등).',
    'about.fic.title': '허구',
    'about.fic.li1': '《강화 할당》 예산, 크레딧당 비용, 《접근 등급》 임계값, 지역 접근 라인, 《코호트 배치》 백분위. 이는 실재 생명공학 제품이 이런 것들을 어떻게 가격 매기고 순위 매길 수 있는지를 모델링한 것이지, 현재 기술이 실제로 할 수 있는 것을 표현한 것이 아닙니다.',
    'about.fic.li2': '《사회적 결과 브리프》의 문항들. 사회과학의 기대 효과 및 접근 불일치에 관한 직관에 기반한 휴리스틱이지만, 예측력은 없습니다.',
    'about.fic.li3': '《분기 사건》들. 가상의 전기입니다; 실재하는 것은 그 <em>원리</em>(평범한 생활 사건들이 특성 예측을 능가한다는 것)입니다.',
    'about.fic.li4': 'DiceBear 아바타. 일러스트로 된 대리물이며, 사진이 아닙니다.',
    'about.process.h': '제작 노트',
    'about.process.p1': '바닐라 HTML / CSS / JavaScript로 제작했습니다 — 프레임워크 없음, 빌드 단계 없음. 누구나 소스를 읽을 수 있습니다. 아바타 스타일은 <a href="https://www.dicebear.com" style="color: var(--accent); text-decoration: none;">DiceBear</a>에서 CDN으로 불러옵니다.',
    'about.process.p2': '반복적으로 설계했습니다. 첫 버전은 "귀여운 아기 만들기" 장난감이었습니다. 여러 세션을 거치며, 세 모드의 윤리 인터페이스로 자라났습니다. 사용자가 거치는 호 — 장난스러운 호기심에서 제도적 최적화를 거쳐 조용한 성찰로 — 는, 프로젝트 자체가 구축 과정에서 거친 호이기도 합니다.',
    'about.process.p3': 'GitHub Pages에서 호스팅됩니다. 시뮬레이터는 <a href="./" style="color: var(--accent); text-decoration: none;">acceleration1st.com</a>에 있습니다.',
    'about.cites.h': '참고문헌',
    'about.cite.1': 'Steptoe PC, Edwards RG. Birth after the reimplantation of a human embryo. <em>The Lancet</em>, 312(8085):366, 1978.',
    'about.cite.2': 'Handyside AH, Kontogianni EH, Hardy K, Winston RM. Pregnancies from biopsied human preimplantation embryos sexed by Y-specific DNA amplification. <em>Nature</em>, 344:768–770, 1990.',
    'about.cite.3': 'Jinek M, Chylinski K, Fonfara I, Hauer M, Doudna JA, Charpentier E. A programmable dual-RNA–guided DNA endonuclease in adaptive bacterial immunity. <em>Science</em>, 337(6096):816–821, 2012.',
    ...
    'about.cite.11': 'Bouchard TJ Jr. Genes, environment, and personality. <em>Science</em>, 264(5166):1700–1701, 1994.',
    'about.cite.12': 'Plomin R, DeFries JC, Knopik VS, Neiderhiser JM. <em>Behavioral Genetics</em>, 6th ed. Worth Publishers, 2013.',
    'about.meta': '가상의 시뮬레이션입니다. 의학적 또는 유전적 조언이 아닙니다. 현재의 윤리 규제는 지역에 따라 다릅니다.',
    'language.label': '언어'
  },
  ...
  tr: {
    ...
    'section.env.hint.adult': 'opsiyonel · projeksiyonu inceltmek için ayarla',
    'about.title': 'Hakkında — BabyBlend Lab',
    'about.back': '← Laboratuvara dön',
    'about.h1': 'BabyBlend Lab Hakkında',
    'about.sub': 'İnsan iyileştirmesinin etiğine dair spekülatif bir simülasyon.',
    'about.what.h': 'Bu nedir',
    'about.what.p1': 'BabyBlend Lab, yakın geleceğin bir tüketici biyoteknoloji ürününün kendini nasıl sunabileceğine dair kurgusal, tek sayfalık etkileşimli bir yapıttır: kurumsal dil, güven aralıkları, düzenleyici yasal uyarılar ve özellikler için bir yapılandırma arayüzü. İki ebeveyni girersiniz, isteğe bağlı olarak dokuz kategoriye <em>iyileştirme kredisi</em> dağıtırsınız ve sistem olası bir çocuğu — ve bu seçimlerin toplumsal, düzenleyici ve kimliksel sonuçlarını — öngörür.',
    'about.what.p2': 'Buradaki hiçbir şey gerçek bir çocuğu öngörmez. Mekanikler kasıtlı bir karikatürdür. Arayüzün ortaya koyduğu etik sorular ise öyle değildir.',
    'about.modes.h': 'Üç mod, üç sav',
    'about.modes.intro': 'Aynı kurgusal çocuk üç farklı kayıtta görüntülenebilir. Her mod farklı bir şey savunur.',
    'about.modes.adult.name': 'Yetişkin',
    'about.modes.adult.body': 'Klinik bir biyoteknoloji-ürünü kaydı. Simülasyonu gerçek bir tüketici özelliğiymiş gibi ele alır: Beta etiketleri, maliyet katmanları, düzenleyici bildirimler, projeksiyon-güveni etiketleri. Argüman şudur: <em>neyi optimize etmemelisiniz.</em> Toplumsal Sonuçlar Brifingi, Maliyet/Erişim Katmanı şeridi, Kardeş Kohort varyans satırı, Sapma Olayları ve Tarihsel Sürüklenme zaman çizelgesi birlikte, en otoriter göründüğü anda bile projeksiyonun kırılgan, eşitsiz ve kültürel olarak yerel olduğunu gösterir.',
    'about.modes.reflection.name': 'Düşünüm',
    'about.modes.reflection.body': 'Düşünsel bir kayıt. Aynı çocuğu, yaşamı kaydırıcılara indirgenemeyecek bir kişi olarak ele alır. Argüman şudur: <em>bu projeksiyonların göremediği nedir.</em> Özellik Takımyıldızı, Anı Kartları, İçsel Kohort, Yaşam Boyu Sürüklenme ve Duraklama Paneli; modelin atladığı bir kişilik boyutunu — duyusal doku, özel odalar, on yıllar süren kendini revizyon, bir kaydırıcının soramadığı şeyler — yüzeye taşır.',
    'about.modes.kids.name': 'Çocuk',
    'about.modes.kids.body': 'Hayret / merak kaydı. Simülasyonu dostane bir sınıf nesnesi olarak ele alır — daha yumuşak palet, daha basit etiketler, daha nazik sorular. Üç kayıt arasında en hafif olanı, ve bu kasıtlıdır.',
    'about.real.h': 'Ne gerçek, ne değil',
    'about.real.title': 'Gerçek',
    'about.real.li1': 'Giriş zaman çizelgesindeki her olay ve atıf (1978 IVF, 1990 PGD, 2012 CRISPR-Cas9, 2018 He Jiankui ikizleri, 2019 mahkumiyet, 2020 Nobel Ödülü, 2023 İngiltere Casgevy onayı).',
    'about.real.li2': 'Beş Büyük (OCEAN) kişilik modeli ve ikiz çalışmalarındaki ~%40–60 kalıtsallık aralığı.',
    'about.real.li3': 'OCEAN kaydırıcıları için kullanılan poligenik+Gauss gürültülü kalıtım şekli.',
    'about.real.li4': 'Kozmetik prosedür istatistiği (ISAPS), "Snapchat dismorfisi" (JAMA Facial Plastic Surgery), beden dismorfik bozukluk yaygınlığı (Veale ve ark.) ve kalıtsal düzenlemeyi kısıtlayan 75+ ülke (Baylis ve ark.).',
    'about.fic.title': 'Kurgusal',
    'about.fic.li1': 'İyileştirme Tahsisi bütçesi, kredi başına maliyet, Erişim Katmanı eşikleri, bölgesel erişim satırları ve Kohort Yerleşimi yüzdeliği. Bunlar, gerçek bir biyoteknoloji ürününün bu şeyleri nasıl fiyatlandırıp sıralayabileceğini modeller; mevcut teknolojinin gerçekten yapabildiklerini değil.',
    'about.fic.li2': 'Toplumsal Sonuçlar Brifingi satırları. Sezgisel; sosyal bilimlerin beklenti etkileri ve erişim uyumsuzluğu konusundaki içgüdülerinden beslenir, ama öngörü değildir.',
    'about.fic.li3': 'Sapma Olayları. Kurgusal biyografiler; gerçek olan <em>ilkedir</em> (sıradan yaşam olaylarının özellik projeksiyonlarından daha ağır basması).',
    'about.fic.li4': 'DiceBear avatarları. İllüstre edilmiş vekiller, fotoğraf değil.',
    'about.process.h': 'Yapım notları',
    'about.process.p1': 'Saf HTML / CSS / JavaScript ile inşa edildi — çerçeve yok, derleme adımı yok. Herkes kaynak kodu okuyabilir. Avatar stilleri <a href="https://www.dicebear.com" style="color: var(--accent); text-decoration: none;">DiceBear</a>’dan CDN üzerinden yüklenir.',
    'about.process.p2': 'Yinelemeli olarak tasarlandı. İlk sürüm "sevimli bir bebek yap" oyuncağıydı. Pek çok oturum boyunca üç modlu bir etik arayüze dönüştü. Kullanıcının izlediği yay — şakacı meraktan, kurumsal optimizasyondan geçerek, sessiz bir düşünüme — projenin kendisinin de yapım sürecinde izlediği yaydır.',
    'about.process.p3': 'GitHub Pages’ta barındırılıyor. Simülatör <a href="./" style="color: var(--accent); text-decoration: none;">acceleration1st.com</a> adresinde.',
    'about.cites.h': 'Kaynakça',
    'about.cite.1': 'Steptoe PC, Edwards RG. Birth after the reimplantation of a human embryo. <em>The Lancet</em>, 312(8085):366, 1978.',
    'about.cite.2': 'Handyside AH, Kontogianni EH, Hardy K, Winston RM. Pregnancies from biopsied human preimplantation embryos sexed by Y-specific DNA amplification. <em>Nature</em>, 344:768–770, 1990.',
    'about.cite.3': 'Jinek M, Chylinski K, Fonfara I, Hauer M, Doudna JA, Charpentier E. A programmable dual-RNA–guided DNA endonuclease in adaptive bacterial immunity. <em>Science</em>, 337(6096):816–821, 2012.',
    'about.cite.4': 'Cyranoski D, Ledford H. Genome-edited baby claim provokes international outcry. <em>Nature</em> news, 26 November 2018.',
    ...
    'about.cite.11': 'Bouchard TJ Jr. Genes, environment, and personality. <em>Science</em>, 264(5166):1700–1701, 1994.',
    'about.cite.12': 'Plomin R, DeFries JC, Knopik VS, Neiderhiser JM. <em>Behavioral Genetics</em>, 6th ed. Worth Publishers, 2013.',
    'about.meta': 'Kurgusal simülasyon. Tıbbi veya genetik tavsiye değildir. Mevcut etik düzenlemeler ülkeden ülkeye değişir.',
    'language.label': 'Dil'
  }
};
...
const LABEL_I18N = {
  ...
  // R22rev UX Flow (Sociology MAJOR + Risk MITIGATION): aria-label on the
  // scrubber-ticker so SR users learn the milestone prose is a scrollable
  // region, not a single line that ends where their viewport clips it. Paired
  // with role="region" in index.html; rendered each tick in renderAgingScrubber
  // via localLabel so the hint follows the active language.
  'Milestone description, scrollable': {
    zh: '里程碑描述,可滚动',
    ja: 'マイルストーンの説明、スクロール可能',
    ko: '마일스톤 설명, 스크롤 가능',
    tr: 'Kilometre taşı açıklaması, kaydırılabilir'
  },
...
const ADULT_TRAJECTORY_MILESTONES = {
  ...
  later: {
    en: [
      ...
      // R20: caretaking entry wrapped across zh/ja/ko/tr — closes the last
      // cross-lang shape-tag asymmetry; all 5 tagged shapes (stability×2,
      // mixed, caretaking, interruption, bloom, precarity) now span all langs.
      { text: "A disruption in this decade — illness, job loss, caregiving crisis, or other shock — reshapes priorities. What emerges after is different from what was planned, and not always 'recovered'; some change reshapes the trajectory permanently.", life_shape: 'interruption' },
    ...
    zh: [
      ...
      { text: '照护年迈的父母、手足或伴侣,打断了原本预设的人生轨道;身份围绕着"谁需要他/她"重新组织。', life_shape: 'caretaking' },
      { text: "这个十年里的一次扰动——疾病、失业、照护危机或其他冲击——重塑了优先事项。其后浮现的与原本计划的不同,也并非总能'复原';有些变化会永久地改变轨迹。", life_shape: 'interruption' },
      { text: '一次迟到的绽放:他/她为人所识的那件事——在自己和他人眼中——出现在大多数同龄人都已认定形状已定之后。', life_shape: 'bloom' },
      { text: '在这十年间,经济上的不稳定仍持续困扰着相当一部分同代人;稳定并非平均分布。', life_shape: 'precarity' }
    ],
    ja: [
      ...
      { text: '老いた親、きょうだい、あるいは伴侶のケアが、想定されていた軌道を中断させる。アイデンティティは「誰が自分を必要としているか」を軸に再編される。', life_shape: 'caretaking' },
      { text: "この十年に訪れる混乱——病、失職、ケアの危機、その他の衝撃——が、優先順位を組み替える。その後に現れるものは、当初の計画とは違い、必ずしも『回復』するわけではない。なかには、軌道を恒久的に変える変化もある。", life_shape: 'interruption' },
      { text: '遅咲き――本人にも周囲にも「この人といえばこれ」と認識されるものが、同世代の多くが「もう形は決まった」と見なした後に現れる。', life_shape: 'bloom' },
      { text: 'この十年に入っても、相当な割合のコホートでは経済的不安定さが続いている。安定は均等には分配されていない。', life_shape: 'precarity' }
    ],
    ko: [
      ...
      { text: '나이 든 부모, 형제자매, 혹은 배우자에 대한 돌봄이 예정된 궤적을 끊는다. 정체성은 "누가 자신을 필요로 하는가"를 중심으로 재편된다.', life_shape: 'caretaking' },
      { text: "이 십 년 사이에 닥치는 혼란 — 질병, 실직, 돌봄의 위기, 그 외의 충격 — 은 우선순위를 다시 짠다. 그 뒤에 나타나는 것은 본래 계획과 다르며, 늘 '회복'되지도 않는다. 어떤 변화는 궤적을 영구히 바꾸어 놓는다.", life_shape: 'interruption' },
      { text: '늦은 개화: 본인과 주위 모두에게 그 사람을 그 사람이게 하는 것이, 또래 대부분이 이미 형태가 정해졌다고 여긴 뒤에 도착한다.', life_shape: 'bloom' },
      { text: '이 10년대에 들어서도 적지 않은 코호트에서 경제적 불안정이 지속된다. 안정은 고르게 분배되어 있지 않다.', life_shape: 'precarity' }
    ],
    tr: [
      ...
      { text: 'Yaşlanan bir ebeveyne, bir kardeşe ya da bir eşe bakım vermek, öngörülen ekseni keser; kimlik, kime ihtiyaç duyulduğu etrafında yeniden düzenlenir.', life_shape: 'caretaking' },
      { text: "Bu on yıldaki bir sarsıntı — hastalık, iş kaybı, bakım krizi ya da başka bir şok — öncelikleri yeniden şekillendirir. Sonrasında ortaya çıkan, planlanandan farklıdır ve her zaman 'iyileşme' getirmez; bazı değişiklikler yörüngeyi kalıcı olarak değiştirir.", life_shape: 'interruption' },
      { text: 'Geç açan bir çiçek: kişinin kendisi ve başkaları için onu tanıdığımız şey, akranların çoğunun biçimin artık oturduğunu varsaymasından sonra gelir.', life_shape: 'bloom' },
      { text: 'Bu on yılda da kohortların azımsanmayacak bir bölümü için ekonomik kırılganlık sürer; istikrar eşit biçimde dağılmamıştır.', life_shape: 'precarity' }
    ]
  }
};
...
const HISTORY_CARDS = [
  ...
  { title: 'Life shapes are patterns, not fates.', body: 'Sociologists describe adult trajectories — settled career, persistent precarity, late bloom, identity reorganized around caregiving, an arc interrupted by illness or loss — as life-course patterns produced largely by structural conditions: labor markets, housing, health systems, caregiving load, the timing of historical events a cohort lives through (Elder, 1998, life-course theory; Settersten, 2003 on linked lives and cohort effects). Two people with similar traits can land in very different shapes depending on what their decade hands them. When this simulator picks one trajectory shape for a future adult, it is sampling from those structural patterns — not predicting an inner destiny.',
    i18n: {
      zh: { title: '人生形态是模式,不是命运。', body: '社会学家将成年人的轨迹——稳定的职业、长期的不稳定、晚开的花、围绕照护重塑的身份、被疾病或丧失打断的弧线——描述为生命历程中的"模式",它们主要由结构性条件塑造:劳动力市场、住房、医疗体系、照护负担,以及一个世代所亲历的历史事件的时机(Elder, 1998,生命历程理论;Settersten, 2003,关于"相连的人生"与世代效应的研究)。两个性格相似的人,可能因为各自的时代递给他们不同的牌,而走入截然不同的形态。当本模拟器为一个未来的成年人挑选一种轨迹形态时,它是在从这些结构性模式中抽样——而不是在预言某种内在的命运。' },
      ja: { title: '人生のかたちはパターンであって、運命ではない。', body: '社会学者は成人期の軌跡——落ち着いたキャリア、長く続く不安定、遅れて咲く花、ケアを軸に組み直されるアイデンティティ、病や喪失によって中断される弧——を、構造的条件によって大きく形づくられる「ライフコースのパターン」として記述してきた:労働市場、住宅、医療制度、ケア負担、ひとつのコホートが生きる歴史的出来事の時機(Elder, 1998 ライフコース理論;Settersten, 2003「結びついた人生」とコホート効果)。性格の似た二人が、その十年に何を手渡されるかによって、まったく異なるかたちに行き着くことがある。本シミュレーターが未来の成人にひとつの軌跡のかたちを選ぶとき、それはこれらの構造的パターンから抽出しているのであって、内的な運命を予言しているわけではない。' },
      ko: { title: '인생의 모양은 패턴이지, 운명이 아니다.', body: '사회학자들은 성인기의 궤적 — 안정된 경력, 지속되는 불안정, 늦은 개화, 돌봄을 중심으로 재편되는 정체성, 질병이나 상실로 끊어진 호 — 을 주로 구조적 조건이 빚어내는 "생애과정 패턴"으로 기술한다: 노동 시장, 주거, 의료 체계, 돌봄 부담, 한 코호트가 겪는 역사적 사건들의 시점(Elder, 1998 생애과정 이론; Settersten, 2003 "연결된 삶"과 코호트 효과). 성향이 비슷한 두 사람도, 각자의 10년이 그들 손에 무엇을 쥐어 주느냐에 따라 매우 다른 모양에 도달할 수 있다. 본 시뮬레이터가 미래의 성인에게 하나의 궤적 모양을 고를 때, 그것은 이런 구조적 패턴들로부터 표본을 뽑는 것이지, 내적인 운명을 예언하는 것이 아니다.' },
      tr: { title: 'Hayat şekilleri kalıplardır, kader değil.', body: 'Sosyologlar yetişkin yörüngelerini — oturmuş bir kariyer, süregelen güvencesizlik, geç açan bir çiçek, bakım yükümlülüğü etrafında yeniden örülen kimlik, hastalık ya da kayıpla kesilen bir yay — büyük ölçüde yapısal koşulların ürettiği yaşam-seyri kalıpları olarak tanımlar: işgücü piyasaları, konut, sağlık sistemleri, bakım yükü, bir kuşağın yaşadığı tarihsel olayların zamanlaması (Elder, 1998 yaşam-seyri kuramı; Settersten, 2003 "bağlı yaşamlar" ve kuşak etkileri). Benzer mizaca sahip iki kişi, o on yılın onlara ne uzattığına göre çok farklı şekillerde son bulabilir. Bu simülatör gelecekteki bir yetişkin için bir yörünge şekli seçtiğinde, içsel bir kaderi öngörmüyor — bu yapısal kalıplardan örneklem alıyor.' }
    } }
];
...
function renderAgingScrubber() {
  ...
  if (ticker) {
    ticker.textContent = pickAgeTicker(age);
    ticker.setAttribute('aria-label', localLabel('Milestone description, scrollable'));
  }
