...
const LABEL_I18N = {
  ...
  'These are one set of patterns this person might encounter — not a forecast.': { zh: '这只是这个人可能经历的一组模式 —— 而非预言。', ja: 'これは、この人物が経験しうる一つのパターン群にすぎず、予測ではない。', ko: '이는 이 사람이 마주칠 수 있는 하나의 패턴 묶음일 뿐 — 예측이 아니다.', tr: 'Bunlar bu kişinin karşılaşabileceği olası örüntüler — bir tahmin değil.' },
